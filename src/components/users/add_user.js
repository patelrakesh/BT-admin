...
class Adduser extends Component {
  ...
  componentDidMount = async () => {
    ...
    this.validator.hideMessageFor("Phonenumber");
  ...
  nextuser = async () => {
    if (this.validator.allValid() && this.state.role !== '' && this.state.oraganization !== '') {
      ...
      this.state.role === '' && this.setState({ messageForRole: true });
      this.state.oraganization === '' && this.setState({ messageForOraganization: true });
          ...
          <div>
                    ...
                    <Col md="6">
                      <FormGroup>
                        ...
                        <Select
                          ...
                          onChange={role => this.setState({ role: role, messageForRole: false })}
                          onBlur={() => this.state.role === '' ? this.setState({messageForRole: true}) : this.setState({messageForRole: false})}
                          options={roleadduser}
                          placeholder="Select Roles"
                        />
                        {this.state.messageForRole && <p className="required_message">Role is required.</p>}
                      </FormGroup>
                    </Col>
                    <Col md="6">
                      <FormGroup>
                      ...
                      <FormGroup>
                        ...
                        <Select
                          value={this.state.oraganization}
                            onChange={oraganization => this.setState({ oraganization: oraganization, messageForOraganization: false })}
                          onBlur={() => this.state.oraganization === '' ? this.setState({messageForOraganization: true}) : this.setState({messageForOraganization: false})}
            ...
            {this.state.addnextmodaluser && (
              <Primarylocation
                ...
                isclosemodalsuserback={this.isclosemodalsuserback}
